          ...
          {step === "form" ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {success && (
                  <div className="flex items-center gap-2 text-sm text-emotion-happy bg-emotion-happy/10 p-3 rounded-lg">
            ...
            <>
              ...
              {error && (
                <div className="flex items-center justify-center gap-2 text-sm text-destructive bg-destructive/10 p-3 rounded-lg mt-6">
                  <AlertCircle className="h-4 w-4" />
                  {error}
                </div>
              )}
              ...
              {success && (
                <div className="flex items-center justify-center gap-2 text-sm text-emotion-happy bg-emotion-happy/10 p-3 rounded-lg mt-6">
                  <CheckCircle className="h-4 w-4" />
                  {success}
                </div>
              )}
