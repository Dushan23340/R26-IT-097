"""v2 of evaluate_fused_model.py - evaluates model/best_fused_model_v2 on
its own held-out split (dataset/facial_features_v2.npz, same
...
print("Loading model/best_fused_model_v2.keras")
...
plt.ylabel("Actual")
plt.tight_layout()
plt.savefig("model/fused_confusion_matrix_v2.png")
print("Saved confusion matrix to model/fused_confusion_matrix_v2.png")
