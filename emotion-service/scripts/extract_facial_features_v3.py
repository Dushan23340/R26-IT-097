"""v3 of extract_facial_features.py - same MediaPipe blendshape/head-pose
extraction as v2, pointed at dataset/final_dataset (the real 6-class set:
Happy/Frustrated/Bored/Angry/Normal/Confused) instead of the 3-class
expression_dataset_v2 (Angry/Happy/Normal only) that v2 - and the
currently-served best_fused_model.h5 - was actually trained on.
...
OUTPUT_PATH = SERVICE_DIR / "dataset" / "facial_features_v3.npz"
